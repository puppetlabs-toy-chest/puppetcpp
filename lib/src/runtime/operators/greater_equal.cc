...
namespace puppet { namespace runtime { namespace operators {
    ...
    {
        greater_equal_visitor(lexer::position const& left_position, lexer::position const& right_position) :
    ...
    value greater_equal::operator()(binary_context& context) const
    {
        return boost::apply_visitor(greater_equal_visitor(context.left_position(), context.right_position()), dereference(context.left()), dereference(context.right()));
    }
