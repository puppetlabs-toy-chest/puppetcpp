...
namespace puppet { namespace runtime { namespace operators {
    ...
    {
        less_equal_visitor(lexer::position const& left_position, lexer::position const& right_position) :
    ...
    {
        return boost::apply_visitor(less_equal_visitor(context.left_position(), context.right_position()), dereference(context.left()), dereference(context.right()));
    }
