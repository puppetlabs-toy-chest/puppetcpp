...
namespace boost { namespace spirit { namespace qi {
    ...
    info plain_token<puppet::compiler::lexer::token_id>::what(Context&) const
    {
    ...
    {
        return boost::spirit::info("token", boost::lexical_cast<std::string>(static_cast<puppet::compiler::lexer::token_id>(id)));
    }
    /**
     * Specialization for information for tokens with id type token_id.
     * @tparam Context The type of context.
    ...
    template <>
    template <typename Context>
    info plain_raw_token<puppet::compiler::lexer::token_id>::what(Context&) const
    {
    ...
    {
        return boost::spirit::info("raw_token", boost::lexical_cast<std::string>(static_cast<puppet::compiler::lexer::token_id>(id)));
    }
    /** @endcond */
