...
namespace puppet { namespace lexer {
    ...
    struct number_token
    {
         ...
         */
        typedef boost::variant<std::int64_t, long double> value_type;
...
namespace boost { namespace spirit { namespace traits
{
    ...
    struct assign_to_attribute_from_iterators<puppet::lexer::number_token, Iterator>
    {
        /**
         ...
         */
        static void call(Iterator const& first, Iterator const& last, puppet::lexer::number_token& attr)
        {
